...
(data-frame-write-delim (data-frame-concat-vertical data-frame-integer-1 data-frame-integer-2))
...
(define columns-mixed-3
  (list 
   (cons 'col1 (new-ISeries (vector 1 2 3 4 5)))
   (cons 'col2 (new-NSeries (flvector 25.3 26.3 27.3 28.3 32.1)))
   (cons 'col3 (new-CSeries (vector 'e 'f 'g 'h 'i)))
   (cons 'col4 (new-ISeries (vector 1 2 3 4 7)))))

; create new data-frame-mixed-3
(define data-frame-mixed-3 (new-data-frame columns-mixed-3))

(data-frame-write-delim data-frame-mixed-3)

(data-frame-write-delim (data-frame-concat-horizontal data-frame-mixed-2 data-frame-mixed-3))
