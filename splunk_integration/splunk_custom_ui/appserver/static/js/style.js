    ...
    $(document).on("full_render_complete", function (e, opts) {
      ...
      all_views.forEach(function (view) {
        ...
        if (view.subview && view.subview.table) {
          ...
          if ((mail_format && eval(mail_format)) || (!custom_cell_renderers_success[view.subview.id])) {
        ...
        if (view.subview && view.subview.table && !nested_headers_formatted[view.subview.id]) {
